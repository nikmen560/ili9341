...
#define CDC_IN_PACKET					64
#define CDC_OUT_PACKET					64

/* USB CP2103 device Configuration Descriptor */
//__ALIGN_BEGIN static uint8_t USBD_HID_CfgDesc[USB_CDC_CONFIG_DESC_SIZ] __ALIGN_END =
//{
//  0x09, /* bLength: Configuration Descriptor size */
//  USB_CONFIGURATION_DESCRIPTOR_TYPE, /* bDescriptorType: Configuration */
...
//  CDC_IN_PACKET, /*wMaxPacketSize: 64 Byte max */
//  0x00,
...
//  0x02,
//  CDC_OUT_PACKET,/*wItemLength: Total length of Report descriptor*/
//  0x00,
//  0x00,          /*bInterval: Polling Interval (10 ms)*/
///* 32 */
//} ;
