...
*******************************************************************************
  ...
  FileName     : LCD_Touch_Calibration.c      
  Version      : 1.0.0     
  Date         : 2012/06/25
  Description  : LCD touch screen calibration
  Function List: 
  History      :    
  <time>       : 2012/06/25
  <version >   : 1.0.0 	
...
/* Private functions ---------------------------------------------------------*/
/******************************************************************************
  Function:       Lcd_Touch_Calibration
  Description:    Lcd_Touch Calibration	test
  Calls:          
  Called By:      
  Input:          
  Output:         
...
/******************************************************************************
  Function:       Calibration_Test_Dispose
  Description:    Display the value of calibration point
  Calls:          
  Called By:      
  Input:          
  Output:         
